...
final class FOSUserEvents
{
    ...
    /**
     * The CHANGE_PASSWORD_FAILURE event occurs when the change password form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    ...
    /**
     * The GROUP_CREATE_FAILURE event occurs when the group creation form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    ...
    /**
     * The GROUP_EDIT_FAILURE event occurs when the group edit form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    ...
    /**
     * The PROFILE_EDIT_FAILURE event occurs when the profile edit form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    ...
    /**
     * The REGISTRATION_FAILURE event occurs when the registration form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    ...
    /**
     * The RESETTING_RESET_FAILURE event occurs when the resetting form validation fails.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
